...
def load_checkpoint(model,
    ...
    if 'state_dict' in checkpoint:
        ...
        state_dict = checkpoint['model'] #this
    ...
    rank, _ = get_dist_info()
    if "rel_pos_bias.relative_position_bias_table" in state_dict: #yes
        if rank == 0:
            print("Expand the shared relative position embedding to each layers. ")
        num_layers = model.get_num_layers()
        rel_pos_bias = state_dict["rel_pos_bias.relative_position_bias_table"] #yes
