...
class CrossFewSegViT(FewEncoderDecoder):
    ...
    def __init__(self,
                ...
                #  init_cfg=None,
                 **args):
        super(CrossFewSegViT, self).__init__(**args)
    ...
    def forward(self, img, img_metas, return_loss=True, **kwargs):
        if return_loss:
            ...
            ## register cross base prototypies:
            if len(self.base_class) == 0: #generalized few-shot setting
                if not hasattr(self, 'novel_queries'):
                    print('------------Registering the prototypes of all classes-----------')
