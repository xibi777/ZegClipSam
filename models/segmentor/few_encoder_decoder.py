...
class FewEncoderDecoder(FewBaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(FewEncoderDecoder, self).__init__(init_cfg)
    ...
    def whole_inference(self, img, img_meta, rescale, novel_protoes=None):
        """Inference with full image."""

        if novel_protoes is not None:
            seg_logit = self.encode_decode(img, img_meta, novel_protoes)
        else:
    ...
    def aug_test(self, imgs, img_metas, rescale=True, novel_protoes=None):
        ...
        if novel_protoes is not None:
            seg_logit = self.inference(imgs[0], img_metas[0], rescale, novel_protoes)
        else:
