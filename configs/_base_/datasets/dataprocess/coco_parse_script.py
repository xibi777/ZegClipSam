...
partition = 'val'
# /media/data/ziqin/data_fss/coco2014/annotations/instances_train2014.json
annFile = '/media/data/ziqin/data_fss/coco2014/annotations/instances_{}2014.json'.format(partition)
save_dir = '/media/data/ziqin/data_fss/coco2014/annotations/{}_contain_crowd'.format(partition)
img_dir = '/media/data/ziqin/data_fss/coco2014/{}2014'.format(partition)
save_iscrowd = True
