...
class ZeroPascalVOCDataset21(CustomDataset):
    """Pascal VOC dataset.
    Args:
    ...
    def __init__(self, split, **kwargs):
        super(ZeroPascalVOCDataset21, self).__init__(
            img_suffix='.jpg', 
            seg_map_suffix='.png', 
            split=split, 
    ...
    def multi_evaluate(self,
        ...
        # result each results:
        return_results = {}
        return_results['pAcc'] = ret_metrics['aAcc']
        return_results['mIoU_S'] = ret_metrics['IoU'][seen_idx].mean()
        return_results['mIoU_U'] = ret_metrics['IoU'][unseen_idx].mean()
        return_results['hIoU'] = (2 * ret_metrics['IoU'][seen_idx].mean() * ret_metrics['IoU'][unseen_idx].mean()) / (ret_metrics['IoU'][seen_idx].mean() + ret_metrics['IoU'][unseen_idx].mean())
        # return_results['seen_acc'] = ret_metrics['Acc'][seen_idx].mean()
        # return_results['unseen_acc'] = ret_metrics['Acc'][unseen_idx].mean()
        ...
        # return eval_results
        return eval_results, return_results 