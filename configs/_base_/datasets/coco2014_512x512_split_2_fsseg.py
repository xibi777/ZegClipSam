# dataset settings
dataset_type = 'BinaryCOCO2014Dataset'
...
data = dict(
    ...
    train=dict(
        ...
        split='ImageSets/FewShotSegmentation/train_split_' + str(split) + '.txt',
    ...
    val=dict(
        ...
        split='ImageSets/BinaryFewShotSegmentation/val_split_' + str(split) + '.txt',
