_base_ = [
    '../_base_/models/fewsegvit.py', '../_base_/datasets/voc12_512x512_split_1_ft.py',
...
eval_supp_path = '/media/data/ziqin/data_fss/VOC2012/ImageSets/FewShotSegmentation/val_supp_split_1_shot_1_seed1.txt'
...
model = dict(
    ...
    decode_head=dict(
        ...
        tune='bias', # Tune whole decoder; Tune k/v/f; Tune bias
        loss_decode=dict(
