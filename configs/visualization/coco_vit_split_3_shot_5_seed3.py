_base_ = [
    '../_base_/models/fewsegvit.py', '../_base_/datasets/coco2014_81_512x512_split_3.py',
...
eval_supp_path = '/media/data/ziqin/data_fss/coco2014/ImageSets/FewShotSegmentation/val_supp_split_3_shot_5_seed3.txt'
