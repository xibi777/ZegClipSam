_base_ = [
    '../_base_/models/fewsegvit.py', '../_base_/datasets/coco2014_512x512_split_1_fsseg.py',
...
eval_supp_path = '/media/data/ziqin/data_fss/coco2014/ImageSets/BinaryFewShotSegmentation/val_split_supp_1_5_1000.npy'
