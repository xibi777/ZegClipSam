_base_ = [
    '../_base_/models/caplseg.py', '../_base_/datasets/coco2014_512x512_fully.py',
...
eval_supp_path = '/media/data/ziqin/data_fss/coco2014/ImageSets/FewShotSegmentation/val_supp_split_0_shot_1_seed1.txt'
...
optimizer = dict(type='SGD', lr=0.01, weight_decay=0.01, 
