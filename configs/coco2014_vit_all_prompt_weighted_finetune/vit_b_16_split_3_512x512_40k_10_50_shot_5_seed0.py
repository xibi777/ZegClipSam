_base_ = [
    '../_base_/models/fewsegvit.py', '../_base_/datasets/finetuning_config/coco2014_512x512_shot_5_seed0.py',
...
eval_supp_path = '/media/data/ziqin/data_fss/coco2014/ImageSets/FewShotSegmentation/val_supp_split_3_shot_5_seed0.txt'
