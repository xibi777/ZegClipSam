_base_ = [
    '../_base_/models/zegclip.py', '../_base_/datasets/context_60_512x512.py',
...
pretrained = '/media/data/ziqin/pretrained/ViT-B-16.pt'
...
model = dict(
    ...
    ft_backbone = False,
    exclude_key='prompt',
    load_text_embedding='/media/data/ziqin/code/ZegCLIP_test/ZegCLIP/configs/_base_/datasets/text_embedding/context_multi.npy'
